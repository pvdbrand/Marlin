...
#define STRING_CONFIG_H_AUTHOR "PvdB" // Who made the changes.
...
//#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 685.0
  #define XY_DIAG_BD 682.0
  #define XY_SIDE_AD 540
